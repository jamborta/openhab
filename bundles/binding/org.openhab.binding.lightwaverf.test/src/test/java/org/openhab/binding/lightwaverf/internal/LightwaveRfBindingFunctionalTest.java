...
public class LightwaveRfBindingFunctionalTest {
	...
	public void testHeatingInfoResponseReceived() throws Exception {
		...
		itemConfigAndExpectedStates.add(new ItemConfigAndExpectedState(new NumberItem("VALVE_POSITION"), "serial=064402,type=HEATING_VALVE_POSITION", new DecimalType("100")));
